...
public class EmployeeInfo extends JFrame implements ActionListener{
    ...
    EmployeeInfo()
    {
        ...
        choice = new Choice();
        choice.add("Front Desk");
        choice.add("House Keeping");
        choice.add("Kitchen Staff");
    ...
    if (e.getSource() == add) {
        String Q = "select * from employee where Job='" + choice.getSelectedItem() + "'";
        try {
            Von c = new Von();  
            ResultSet resultSet = c.statement.executeQuery(Q);
            table.setModel(DbUtils.resultSetToTableModel(resultSet));
