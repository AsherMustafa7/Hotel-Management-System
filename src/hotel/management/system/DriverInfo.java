...
public class DriverInfo extends JFrame implements ActionListener{
    ...
    if (e.getSource() == add) {
        ...
        String Q1 = "select * from driver where avaliable = 'Yes'";
