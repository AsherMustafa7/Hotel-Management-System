...
public class AddDRIVER extends JFrame implements ActionListener{
    ...
    AddDRIVER()
    {
        ...
        JPanel panel = new JPanel() {
            ...
            protected void paintComponent(Graphics g) {
                ...
                g2d.setComposite(AlphaComposite.getInstance(AlphaComposite.SRC_OVER, 0.2f)); // 50% opacity
        ...
        //--------------------------------------------------------------------------------------------------------------------------------------
            ...
            lable2.setForeground(new Color(231,235,246));
            panel.add(lable2);
        ...
        //---------------------------------------------------------------------------------------------------------------------------------
            ...
            lable3.setForeground(new Color(231,235,246));
            panel.add(lable3);
            ...
            t3.setBackground(new Color(118,123,119));
            panel.add(t3);
             ...
             lable5.setForeground(new Color(231,235,246));
             panel.add(lable5);
             ...
             t5.setBackground(new Color(118,123,119));
             panel.add(t5);


             //------------------------------------------------------------------------------------------------------------------------------
      
             JLabel lable4= new JLabel("Location");
             lable4.setBounds(95,450,200,32);
             lable4.setFont(new Font("Tahoma",Font.BOLD,22));
             lable4.setForeground(new Color(231,235,246));
             panel.add(lable4);
             ...
             t4.setBackground(new Color(118,123,119));
             panel.add(t4);
        ...
        //---------------------------------------------------------------------------------------------------------------------------
            ...
            lable8.setForeground(new Color(231,235,246));
            panel.add(lable8);

            
            m = new JRadioButton("Male");
            m.setBounds(405,330,100,32);
            m.setBackground(new Color(118,123,119));
            ...
            f.setBackground(new Color(118,123,119));
        ...
        //-----------------------------------------------------------------------------------------------------------------------------
            ...
            JLabel lable6= new JLabel("Avaliable");
            lable6.setBounds(900,290,200,32);
            lable6.setFont(new Font("Tahoma",Font.BOLD,22));
            lable6.setForeground(new Color(231,235,246));
            panel.add(lable6);
            ...
            t6.setBackground(new Color(118,123,119));
            panel.add(t6);

        //-----------------------------------------------------------------------------------------------------------------------------


            JLabel lable9= new JLabel("Car Company");
            lable9.setBounds(360,600,200,32);
            lable9.setFont(new Font("Tahoma",Font.BOLD,22));
            lable9.setForeground(new Color(231,235,246));
            panel.add(lable9);
            ...
            t9.setBackground(new Color(118,123,119));
            panel.add(t9);
 

        //-----------------------------------------------------------------------------------------------------------------------------

            JLabel lable10= new JLabel("Car name");
            lable10.setBounds(1170,200,200,32);
            lable10.setFont(new Font("Tahoma",Font.BOLD,22));
            lable10.setForeground(new Color(231,235,246));
            panel.add(lable10);

            t10= new JTextField();
            t10.setBounds(1235,240,200,32);
            t10.setFont(new Font("Tahoma",Font.BOLD,14));
            t10.setForeground(Color.white);
            t10.setBackground(new Color(118,123,119));
            panel.add(t10);
        ...
        b1.setBackground(new Color(118,123,119));
        ...
        b2.setBackground(new Color(118,123,119));
        ...
        ImageIcon imageIcon7 =new ImageIcon("C:\\Users\\acer\\OneDrive\\Desktop\\making final app\\Trying\\src\\icon\\output-onlinegiftools (21).gif");
        ...
        //----------------------------------------------------------------------------------------------------------------------------
        ImageIcon imageIcon8 =new ImageIcon("C:\\Users\\acer\\OneDrive\\Desktop\\making final app\\Trying\\src\\icon\\output-onlinegiftools (19).gif");
        ...
        panel.add(label88);
         ...
         //----------------------------------------------------------------------------------------------------------------------------
         ImageIcon imageIcon9 =new ImageIcon("C:\\Users\\acer\\OneDrive\\Desktop\\making final app\\Trying\\src\\icon\\output-onlinegiftools (20).gif");
         ...
         label99.setBounds(580,630,200,200);
         panel.add(label99);
        ...
        //----------------------------------------------------------------------------------------------------------------------------
        ImageIcon imageIcon =new ImageIcon("Trying/src/icon/Designer (27).jpeg");
    ...
    public void actionPerformed(ActionEvent e)
    {
        if(e.getSource()==b1)
        {
                ...
                String carname = t10.getText();
                String company = t9.getText(); 
