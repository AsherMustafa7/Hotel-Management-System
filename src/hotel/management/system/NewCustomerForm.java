...
public class NewCustomerForm extends JFrame implements ActionListener{
    ...
    NewCustomerForm()
    {
        ...
        //--------------------------------------------------------------------------------------------------------------------------------------
            ...
            JLabel lable2= new JLabel("Add New Customer");
            lable2.setBounds(650,10,300,35);
        ...
        //---------------------------------------------------------------------------------------------------------------------------------
            ...
            panel.add(t3);
             ...
             JLabel lable4= new JLabel("Cheak-In Time");
        ...
        //-----------------------------------------------------------------------------------------------------------------------------
            ...
            JLabel lable6= new JLabel("Stay Days");
            lable6.setBounds(900,290,200,32);
            lable6.setFont(new Font("Tahoma",Font.BOLD,22));
            lable6.setForeground(new Color(93,46,29));
            panel.add(lable6);

            t6= new JComboBox(new String[] {"1-5 days","5-10 days","10-15 days","15-20 days","20-30 days","More than a Month"});
    ...
    public void actionPerformed(ActionEvent e)
    {
        if(e.getSource()==b1)
        {
                ...
                try
                {
                    ...
                    String q ="insert into customer values('"+name+"','"+age+"','"+gender+"','"+job+"','"+income+"','"+phone+"','"+email+"','"+aadhar+"')";
